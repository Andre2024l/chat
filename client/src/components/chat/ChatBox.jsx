...
const ChatBox = () => {
    ...
    }, [messages]); // Scroll default ao receber mensagem
    ...
    return <Stack gap={4} className="chat-box">
        ...
        <Stack  gap={3} className="chat-input flex-grow-0" direction="horizontal"> 
                ...
                <button className="send-btn" onClick={() => sendTextMesage(textMessage, user, currentChat?._id, setTextMessage)}>
